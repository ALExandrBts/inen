---
layout: doc
title: Ingenieur-Portfolio
---

# Ingenieur-Portfolio

<div class="portfolio-intro">
  <p class="lead">Infrastruktur für eine souveräne Zukunft</p>
</div>
...
<div class="project-grid">
  ...
  <div class="project-card ucts" onclick="window.open('https://ucts.solutions', '_blank')">
    ...
    <p class="desc">Umwandlung von Rotschlamm in Energiespeicher.</p>
    <ul class="specs">
      <li>🌡️ <b>1000°C</b></li>
      <li>💰 <b>$13.6/kWh</b></li>
      <li>♻️ <b>100%</b> Recycled</li>
    </ul>
    <a href="https://ucts.solutions" target="_blank" class="btn">Projekt ansehen →</a>
  </div>
  ...
  <div class="project-card h2gen" onclick="window.open('https://h2gen.legalgreenplanet.tech', '_blank')">
    ...
    <p class="desc">Hybrider Schiffsantrieb (Wasserstoff + Solar).</p>
    <ul class="specs">
      <li>🚢 <b>-30%</b> Fuel</li>
      <li>⚡ <b>+7%</b> Torque</li>
      <li>📉 <b>-80%</b> Emissions</li>
    </ul>
    <a href="https://h2gen.legalgreenplanet.tech" target="_blank" class="btn">Projekt ansehen →</a>
  </div>
  ...
  <div class="project-card moss" onclick="window.open('https://moss.legalgreenplanet.tech', '_blank')">
    ...
    <p class="desc">Lebendes Dachsystem aus Moos.</p>
    <ul class="specs">
      <li>🏠 <b>Lightweight</b></li>
      <li>🌿 <b>Carbon</b> Negative</li>
      <li>❄️ <b>Nordic</b></li>
    </ul>
    <a href="https://moss.legalgreenplanet.tech" target="_blank" class="btn">Projekt ansehen →</a>
  </div>
...
<div class="about-card">
  ...
  <a href="/de/" class="link">Zur Hauptseite →</a>
</div>
